import { FaAddressBook, FaCalculator, FaCalendarDay, FaHome, FaList, FaSearch, FaShoppingCart, FaVoicemail } from "react-icons/fa";
...
const Dashbord = () => {
    ...
    return (
        <div className="flex">
            <div className="w-44 h-screen bg-orange-300"> 
            <ul className="menu">
                {
                    isAdmin ? <>
                     <li>
